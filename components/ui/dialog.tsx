    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          isExpanded
            ? "max-h-[95vh] max-w-[95vw] lg:max-h-[93vh] lg:max-w-[93vw]"
      ...
      >
        <div className="relative flex w-full h-full flex-col">
          {showCloseButton && (
            <div className={cn("pointer-events-auto absolute flex items-center gap-2 bg-background rounded-t-lg", isExpanded ? "-top-6 lg:-left-4" : "-top-16 -left-[8px] md:-left-[16px] lg:-left-[24px] py-3 px-4")}>
