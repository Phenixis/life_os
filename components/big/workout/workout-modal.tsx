...
export function WorkoutModal({ data, className, triggerButton }: WorkoutModalProps) {
  ...
  const defaultTrigger =
    mode === 'edit-past' || mode === 'edit-saved' ? (
      <Button variant="ghost" size="icon" className={cn('lg:opacity-0 lg:group-hover/workout:opacity-100', className)}>
      ...
      <Button className={cn('', className)}>Start Blank Workout</Button>
    );
  ...
  return (
    <>
                        ...
                        <TableCaption className="mt-0 p-1 flex items-center justify-between text-black dark:text-white">
                          ...
                          {exercices.length === 1 ? (
                            ...
                            >
                              ...
                              <span className="hidden lg:block">Reset Exercise</span>
                            </Button>
                          ) : (
                            <Button
                              size="sm"
                            ...
                            >
                              ...
                              <span className="hidden lg:block">Remove Exercise</span>
                            </Button>
                          )}
                        </TableCaption>
                        <TableHeader>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>{mode === 'edit-saved' ? 'Delete Workout Template' : 'Delete Workout'}</AlertDialogTitle>
            <AlertDialogDescription>
              {mode === 'edit-saved'
