        ...
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="flex items-center gap-1">
              Progress
              <Help size="sm">Compared to 2nd best set</Help>
            </TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {personalRecords.map(record => {
            ...
            if (!hasPrevious) {
              ...
              const changeValue = isWeightChange ? record.weight_diff ?? 0 : isRepChange ? record.nb_reps_diff ?? 0 : 0;
              ...
              if (!isWeightChange && !isRepChange) {
                ...
                const unit = (isWeightChange ? ' kg' : ' rep') + (Math.abs(changeValue) !== 1 ? 's' : '');
