...
export const table = lib.pgTable("meal_planner-ingredient", {
    ...
    userIdIdx: lib.index("meal_planner_ingredient_user_id_idx").on(table.user_id),
    userIdDeletedAtIdx: lib.index("meal_planner_ingredient_user_id_deleted_at_idx").on(table.user_id, table.deleted_at),
}))
